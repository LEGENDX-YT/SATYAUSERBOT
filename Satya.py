...
lnbot = TelegramClient("its_legendboy", API_ID, API_HASH).start(bot_token=token)


class its_LegendBoy(TelegramClient):
...
if Config.SATYA_STRING:
    ...
    sweetie = Its_LegendBoy(session_name, Config.APP_ID, Config.API_HASH)
else:
